...
public class StatsService {
    ...
    public long findAverage(long[] sales) {
        long result = findSum(sales) / sales.length;
        return result;
    }
...
/*
        ...
        int overAverage = findAverage(allPurchases);
        System.out.println("Кол-во месяцев с продажами выше среднего: " + overAverage + " рублей");
